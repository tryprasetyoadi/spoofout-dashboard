    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">Update the data here</p>
                <form @submit.prevent="submitForm" class="forms-sample">
                    <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input v-model="data.name" type="text" class="form-control" id="exampleInputName1"
                            placeholder="Name" />
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Token</label>
                        <input v-model="data.token" type="text" class="form-control" id="exampleInputEmail3"
                            placeholder="Token" />
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" @click="backToClients" class="btn btn-gradient-primary me-2">Update</button>
                    <button type="button" @click="backToClients" class="btn btn-secondary">Back</button>
                </form>
            </div>
        </div>
    </div>
